...
class MemoryEntry(BaseModel):
    """
    Memory Unit - Self-contained fact with multi-view indexing.
    
    Core memory structure with:
    - Semantic Layer: Dense embedding base
    - Lexical Layer: Sparse keyword vectors for BM25 matching
    ...
    lossless_restatement: str = Field(
        ...,
        description="Self-contained fact with coreference resolution (no pronouns) and absolute timestamps"
    )
